...
from pages.secuencia.ui_components import SecuenciaUI
from pages.secuencia.game_logic import GameLogic
from pages.secuencia.camera_handler import CameraHandler

class SecuenciaSeñasGame(ctk.CTkFrame):
